            ...
            synchronized (mCameraStateLock) {
                switch (mState) {
                    case STATE_PREVIEW: {
                        ...
                        //Log.d(TAG, "bob STATE_PREVIEW");
                        break;
                    }
                    case STATE_WAITING_FOR_3A_CONVERGENCE: {
                        Log.d(TAG, "bob STATE_WAITING_FOR_3A");
                        ...
                        if (readyToCapture && mPendingUserCaptures > 0) {
                            Log.d(TAG,"bob readyToCapture pendings:" + mPendingUserCaptures);
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                synchronized (mCameraStateLock) {
                    ...
                    //bob sang
                    Log.d(TAG, "bob Image size:"+largestRaw.getWidth() + "x" + largestRaw.getHeight());
